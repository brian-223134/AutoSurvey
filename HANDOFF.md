...
**8섹션 × 4서브섹션 = 32서브섹션, 서브섹션당 약 625단어 → 약 20,000단어.**
SurveyForge 파일럿(30서브섹션 18,807단어)과 haiku 3편(48서브섹션 25.5k) 사이이고,
84k단어 폭주와는 거리가 멉니다. SurveyForge에서 출력이 100페이지를 넘긴 문제도 같은
뿌리(하한만 있는 길이 지시)이므로 같은 방식으로 잡습니다.
